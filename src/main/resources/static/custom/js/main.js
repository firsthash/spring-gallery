var GalleryModule = (function() {
    ...
    module.CarouselItemView = Backbone.View.extend({
        tagName: 'div',
        className: 'item',
    ...
    module.GalleryModelView = Backbone.View.extend({
        ...
        addOne: function(model, collection) {
            ...
            var carousel = new module.CarouselItemView({model: model, collection: collection});
            var thumbnail = new module.ImageModelView({model: model, collection: collection});
    ...
    module.ImageModelView = Backbone.View.extend({
        events: {
        ...
        showCarousel: function() {
            ...
            module.lastCarousel = carousel;
            module.lastModal = modal;
    ...
    module.SectionView = Backbone.View.extend({
    ...
    module.AppView = Backbone.View.extend({
        events: {},
        ...
        initialize: function() {
            ...
            this.listenTo(this.collection, 'sync', function(collection) {
                ...
                new module.SectionView({model: collection.findWhere({name: 'header'}), collection: collection, el: $('#header')}).render();
                new module.ContactsView({model: collection.findWhere({name: 'contacts'}), collection: collection, el: $('#contacts')}).render();
                new module.SectionView({model: collection.findWhere({name: 'footer'}), collection: collection, el: $('#footer')}).render();
        ...
        addOne: function(model) {
            ...
            if (name.startsWith('GalleryModel')) {
                ...
                var view = new module.GalleryModelView({model: model, collection: collection});
        ...
        bindCarouselKeys: function() {
            $(document).keydown(function(e) {
                var carousel = module.lastCarousel;
                var modal = module.lastModal;
    ...
    $(function() {
        new module.AppView({collection: galleryModelList});
    });
