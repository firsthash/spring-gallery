    ...
    var AppView = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.listenTo(this.collection, 'sync', function(collection) {
                ...
                new this.options.SectionView({model: collection.findWhere({name: 'header'}), collection: collection, el: $('#header')}).render();
                new this.options.ContactsView({model: collection.findWhere({name: 'contacts'}), collection: collection, el: $('#contacts')}).render();
