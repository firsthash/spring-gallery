...
var CarouselItemView = Backbone.View.extend({
    ...
    lazyLoad: function() {
        ...
        if (!img.prop('src')) {
            console.log('CarouselItemView...lazyLoad');
...
var GalleryModelView = Backbone.View.extend({
    ...
    events: {
        ...
        'slide .carousel': 'pauseAnimation',
        'slid .carousel': 'lazyLoad',
        'show .modal': 'lazyLoad',
        'hidden .modal': 'pauseAnimation'
    },
...
var ImageModelView = Backbone.View.extend({
    ...
    showCarousel: function() {
        ...
        console.log("viewing gallery with id", galleryID);

        // HACK: carousel require to mark one element as 'active'
        if (!carousel.find('.active')[0]) {
            $(carousel.find('.item')[0]).addClass('active');
        }

        // NOTE: carousel initialization
        ...
        window.lastCarousel = carousel;
        window.lastModal = modal;
...
var AppView = Backbone.View.extend({
    ...
    bindCarouselKeys: function() {
        $(document).keydown(function(e) {
            var carousel = window.lastCarousel;
            var modal = window.lastModal;
